...
class PrivateRecipeApiTests(TestCase):
    def setUp(self):
        ...
        self.another_user = create_user(email="user2@example.com", password="pas123")
    ...
    def test_recipe_other_user_recipe_error(self):
        ...
        recipe = create_recipe(user=self.another_user)
    ...
    def test_create_recipe_with_new_ingredients(self):
        payload = {
            ...
            "time_minutes": 60,
            "price": Decimal("4.90"),
            "ingredients": [{"name": "tacos"}, {"name": "Salt"}],
        }
    ...
    def test_create_recipe_with_existing_ingredient(self):
        ...
        payload = {
            ...
            "time_minutes": 10,
            "price": Decimal("3.90"),
            "ingredients": [{"name": "Lemon"}, {"name": "Teh pucuk"}],
        }
    ...
    def test_filter_by_tags(self):
        ...
        r2 = create_recipe(user=self.user, title="Thai Tea")
        ...
        r1.tags.add(tag1)
        r2.tags.add(tag2)
        r3 = create_recipe(user=self.user, title="Fish and cheap")
